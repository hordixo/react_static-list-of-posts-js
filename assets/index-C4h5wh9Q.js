...
aut aut aut maxime quia temporibus ut omnis`}],Pc=({comment:e})=>V.jsxs("div",{className:"CommentInfo",children:[V.jsxs("div",{className:"CommentInfo__title",children:[V.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",V.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),V.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>V.jsx("div",{className:"CommentList",children:e.map(t=>V.jsx(Pc,{comment:t},t.id))}),Tc=({post:e})=>V.jsxs("div",{className:"PostInfo",children:[V.jsxs("div",{className:"PostInfo__header",children:[V.jsx("h3",{className:"PostInfo__title",children:e.title}),V.jsxs("p",{children:[" Posted by  ",e.user&&V.jsx("a",{className:"UserInfo",href:`mailto:${e.user.email}`,children:e.user.name})]})]}),V.jsx("p",{className:"PostInfo__body",children:e.body}),e.comments&&V.jsx(Lc,{comments:e.comments})]}),Mc=({posts:e})=>V.jsx("div",{className:"PostList",children:e.map(t=>V.jsx(Tc,{post:t},t.id))});function Rc(e){return zc.find(t=>t.id===e)||null}function Dc(e){return Nc.filter(t=>t.postId===e)}const jc=Cc.map(e=>({...e,user:Rc(e.userId),comments:Dc(e.id)})),Oc=()=>V.jsxs("section",{className:"App",children:[V.jsx("h1",{className:"App__title",children:"Static list of posts"}),V.jsx(Mc,{posts:jc})]});em(document.getElementById("root")).render(V.jsx(Oc,{}));
